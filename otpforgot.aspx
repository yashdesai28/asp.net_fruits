<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="otpforgot.aspx.cs" Inherits="_6semprojectfruits.otpforgot" %>
...
<body>
  ...
  <div class="container1" id="blur">
    ...
    <div class="popup" id="popup">
      ...
      <div class="flex1">
        ...
        <div class="dec">
          <p>We've sent a Verification code to your <br> <asp:Label ID="Label1" runat="server" Text=""></asp:Label> </p>
        </div>
 ...
 <form id="form1" runat="server">
     ...
     <asp:Button ID="Button2"   class="reotp"  runat="server" Text="resend-otp" OnClick="Button2_Click" />
          </form>
        </div>
