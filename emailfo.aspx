<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emailfo.aspx.cs" Inherits="_6semprojectfruits.WebForm1" %>
                ...
                <div class="grid-right">
                  <form id="form1" runat="server">
                       ...
                       <asp:HiddenField runat="server" ID="all" Value="" />
                        ...
                        <div class="in-flex">
                            <label>Email</label><asp:TextBox ID="foremail" runat="server" TextMode="Email" placeholder="Enter Email Address" class="input"   onkeyup="emaildemo()"></asp:TextBox>
